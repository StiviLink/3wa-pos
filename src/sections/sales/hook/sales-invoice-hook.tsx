        ...
        <div className="wsc-rsc-dv-actions">
            ...
            <form className="wsc-rsc-dva-mail">
                <div className="wsc-rsc-dva-mail-input">
                    ...
                    <button className="wsc-rsc-dva-mi-button">
                        <Iconify icon='entypo:paper-plane' width={20}/>
                    </button>
                </div>
            </form>
            <div className="wsc-rsc-dva-notice">
                <div className="failed">Email invalide.</div>
            </div>
        </div>
    )
}
    ...
    return(
        <div className="wsc-rsc-dv-container">
            <div className="wsc-rsc-dvc-receipt">
                ...
                <br/>
                <br/>
                <div className="wsc-rsc-dvc-receipt-lines"></div>
                <div className="wsc-rsc-dvc-receipt-right">--------</div>
                <br/>
                <div className="wsc-rsc-dvc-receipt-amount">
                    TOTAL
                    <span className="pos-receipt-right-align">12,00&nbsp;€</span>
                </div>
                <br/>
                <br/>
                <div></div>
                <br/>
                <div className="wsc-rsc-dvc-receipt-amount change"></div>
                <br/>
                <div></div>
                <div className="wsc-rsc-dvc-receipt-taxes"></div>
                <div className="wsc-rsc-dvc-before-footer"></div>
                <div className="wsc-rsc-dvc-after-footer"></div>
                <br/>
                <br/>
                <div className="wsc-rsc-dvc-receipt-order"></div>
            </div>
        </div>
    )
}
